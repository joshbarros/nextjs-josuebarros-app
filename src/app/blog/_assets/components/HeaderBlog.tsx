...
const ButtonPopoverCategories = () => {
  return (
    <Popover className="relative z-30">
      {({ open }) => (
        <>
          <Popover.Button className="link no-underline flex flex-nowrap items-center gap-1 text-base-content/80 hover:text-base-content active:text-base-content focus:text-base-content duration-100">
            Categories
            <svg
      ...
      <nav className="max-w-7xl flex items-center justify-between px-8 py-3 mx-auto">
        ...
        <div className="flex lg:flex-1">
          <Link
            ...
            href="/"
            title="Josué Barros Portfolio"
          >
            <span className="font-extrabold text-lg">Josué Barros</span>
          </Link>
        </div>
